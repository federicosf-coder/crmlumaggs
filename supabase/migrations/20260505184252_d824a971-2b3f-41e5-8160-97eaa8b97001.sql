...
BEGIN
  ...
  WHERE tipo_documento = 'factura'
    AND estatus_factura::text = 'pagado'
  ...
  VALUES (
    'bulk_fix_saldo_facturas_pagadas_2026_05',
    jsonb_build_object(
      'action', 'bulk_update',
    ...
    'Ajuste de saldo a 0 para facturas con estatus pagado sin aplicación de cobranza registrada'
  )
