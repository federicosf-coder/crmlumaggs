...
{"numero_po":"string","numero_orden":"string","almacen_destino":"1001 o 1002","total_monto":0,"moneda":"MXN","estado_general":"string","fecha_entrega_estimada":"YYYY-MM-DD o null","lineas":[{"codigo":"string","descripcion":"string","cantidad":0,"unidad":"string","precio_unitario":0,"precio_neto":0,"estado":"string"}]}
El código del producto son los primeros 9 dígitos de cada línea. La cantidad es el número antes de 'CA','DR','PL' u otra unidad de empaque. almacen_destino: si el campo "Destinatario:" menciona "Mexicali" usa "1001", si menciona "Tijuana" usa "1002". estado_general es el texto que aparece en "Estado de la orden:". estado de cada línea es el texto que aparece debajo de esa línea de producto (ej. "En proceso", "Programado", "Cancelado"). fecha_entrega_estimada es la fecha del campo "Entrega est.:" (viene en formato MM-DD-YYYY en el documento, conviértela a YYYY-MM-DD); si no aparece, usa null.`;
...
{"numero_orden":"string","numero_po":"string","fecha_pedido":"YYYY-MM-DD","planta":"string","almacen_destino":"string","total_monto":0,"moneda":"USD","fecha_entrega_estimada":"YYYY-MM-DD o null","lineas":[{"codigo":"string","nombre":"string","precio_por_galon":0,"galones_por_empaque":0,"cantidad_empaques":0,"precio_total":0}]}
El almacen_destino viene del campo 'Additional Bol'. El código es el número de 8 dígitos. La cantidad de empaques es el número en la columna Quantity. fecha_entrega_estimada es la fecha de entrega estimada si el documento la indica explícitamente (convierte a YYYY-MM-DD); si no aparece, usa null (se calculará después con el lead time estándar).`;
