          ...
          {hasRole("admin") && (
            <ImportExportMenu
              ...
              fields={activeTab === "companies" ? [
                ...
                { key: "id_contpaq", label: "ID Contpaq" },
                ...
                { key: "tipo_cliente_comercial", label: "Tipo Cliente Comercial" },
                { key: "origen_contacto", label: "Origen Contacto" },
                { key: "tomador_decision", label: "Tomador Decisión" },
                { key: "potencial_unidades", label: "Potencial Unidades" },
                { key: "tipo_destino_lubricante", label: "Tipo Destino Lubricante" },
                { key: "rol_lubricante", label: "Rol Lubricante" },
                { key: "evaluacion_lubricante", label: "Evaluación Lubricante" },
                { key: "riesgo_cambio_marca", label: "Riesgo Cambio Marca" },
