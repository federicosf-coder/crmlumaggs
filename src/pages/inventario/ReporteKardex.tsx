            ...
            <Table>
              <TableHeader className="bg-gradient-to-r from-violet-50 to-blue-50 sticky top-0 z-10">
                <TableRow>
                  ...
                  <SortHead k="ultimo_costo" className="text-right">
                    <span title="Costo de lista Galper si está disponible, sino costo promedio del kardex">Último costo (Galper)</span>
                  </SortHead>
                </TableRow>
              </TableHeader>
              <TableBody>
